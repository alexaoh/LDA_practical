...
knitr::kable(df, caption = "Parameter estimates, p-values, AF and HR for each parameter estimate")
```
...
knitr::kable(s1.cox1$coefficients, caption = 'Cox model coefficients')
```
